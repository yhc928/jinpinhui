...
#define JPHToobarHeight 40
@interface JPHpickView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
-(void)setFrameWith:(BOOL)isHaveNavControler{
    CGFloat toolViewX = 0;
    CGFloat toolViewH = _pickeviewHeight+JPHToobarHeight;
    CGFloat toolViewY ;
...
-(void)setUpPickView{
    ...
    pickView.frame=CGRectMake(0, JPHToobarHeight, pickView.frame.size.width, pickView.frame.size.height);
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.frame=CGRectMake(0, JPHToobarHeight, datePicker.frame.size.width, datePicker.frame.size.height);
...
-(UIToolbar *)setToolbarStyle{
    ...
    leftBtn.frame = CGRectMake(0, 0, SCREEN_WIDTH / 3, 44);
    ...
    rightBtn.frame = CGRectMake(0, 0, SCREEN_WIDTH / 3, 44);
...
-(void)setToolbarWithPickViewFrame{
    _toolbar.frame=CGRectMake(0, 0,[UIScreen mainScreen].bounds.size.width, JPHToobarHeight);
}
