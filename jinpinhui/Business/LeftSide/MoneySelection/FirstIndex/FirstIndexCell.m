...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        //进度条背景
        UIView *progressBgView = [[UIView alloc] initWithFrame:CGRectMake(15, 102, SCREEN_WIDTH-85, 6)];
        progressBgView.layer.cornerRadius = 3;
        progressBgView.backgroundColor = UIColorFromRGB(224, 224, 224);
        [self.contentView addSubview:progressBgView];
        
        //进度条
        self.progressView = [[UIView alloc] init];
        self.progressView.layer.cornerRadius = 3;
        self.progressView.backgroundColor = UIColorFromRGB(229, 161, 95);
        [progressBgView addSubview:self.progressView];
        
        //已募集
        self.raiseLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-85, 0, 50, 15)];
        self.raiseLabel.textColor = [UIColor blackColor];
        self.raiseLabel.textAlignment = NSTextAlignmentRight;
        self.originLabel.font = FONT_24PX;
        [self.contentView addSubview:self.originLabel];
    }
